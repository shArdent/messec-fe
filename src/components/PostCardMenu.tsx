...
const PostCardMenu = ({
  ...
  return (
    <div className=" h-auto w-auto">
      ...
      <Modal isOpen={isOpen} closer={setIsOpen} containerStyle="bg-white p-8 rounded flex flex-col gap-8">
        ...
        <div className="w-full flex justify-between items-center gap-3">
          ...
          <button className="w-full py-2 text-[#91A9FF] font-semibold rounded" onClick={() => setIsOpen(false)}>
            Tidak
          </button>
        </div>
      </Modal>
